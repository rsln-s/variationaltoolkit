# Proudly copied from https://github.com/Qiskit/qiskit-aqua/blob/6e745304064580ff2143eb8775d6fc4e05310d0a/qiskit/aqua/translators/ising/docplex.py
# With some extensions courtesy of yours truly
...
def get_general_ising_qubitops(B, bias):
    """
