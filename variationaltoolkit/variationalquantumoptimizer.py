...
class VariationalQuantumOptimizer:
    ...
    def optimize(self):
        ...
        """
        optimizer = getattr(qiskit_optimizers, self.optimizer_name)(**self.optimizer_parameters)
        opt_params, opt_val, num_optimizer_evals = optimizer.optimize(self.obj_w.var_form.num_parameters, 
                                                                      self.obj_w.get_obj(), 
